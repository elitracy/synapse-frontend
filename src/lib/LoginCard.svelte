...
<div class="card-container">
    ...
    <div class="bounds">
        ...
        <div class="text">
            <input type="text" name="email" id="email" class="text-field" placeholder="Email" value={email}>
            <input type="password" name="password" id="pass" class="text-field" placeholder="Password" value={pass}>
        </div>
...
<style>
    .logo{
        ...
        background: url('src/assets/neuron.png') center no-repeat;
    ...
    .card-container{
        ...
        background: url('src/assets/card.svg') no-repeat;
        background-size: contain;
